...
public class Frames extends JFrame implements ActionListener
{
	...
	public Frames()
	{
		...
		setTitle("Auto Releaser");
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 500, 425);	// .., .., length, width
		...
		opened = new JRadioButton("Option 1");
		triaged = new JRadioButton("Option 2");
		...
		JLabel accountNames = new JLabel("Account Names");
		...
		JLabel needsRedo = new JLabel("Not Processesed");
		needsRedo.setBounds(260, 140, 150, 20);
		contentPane.add(needsRedo);
